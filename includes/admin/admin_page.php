...
function render_admin_view(){
  ...
  <div class="wrap">
    ...
    <div id="smdb-1">
      <a href="#" id="btn-start" class="button button-primary">Get Started</a><div class="spinner" style="float:none;"></div>
      <div id="selection" style="display:none;">
        <h4>Excellent! Here are the tables that are currently on this site. Select which ones you want moved to your new site!</h4>
    ...
    <div id="smdb-2" style="width:auto;display:none;">
      <h3>Great! What's the url of your new site?</h3>
      <input id="txt-site" style="width:60%;" type="text" placeholder="http://www.newwordpress.com" value="">
      <a href="#" id="btn-send" class="button button-primary" style="float:right;">Send</a>
      <div id="smdb-2-warnings"></div>
    </div>
